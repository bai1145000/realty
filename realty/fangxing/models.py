...
class FangxingErshouShangpu(models.Model):
    '''房星二手商铺'''
    url = models.CharField(max_length=22020, blank=True, null=True,verbose_name= '数据来源')
    ...
    house_renovation_type = models.CharField(max_length=20, blank=True, null=True,verbose_name= '装修程度')
    house_area = models.CharField(max_length=20, blank=True, null=True,verbose_name= '建筑面积')
    house_direction = models.CharField(max_length=20, blank=True, null=True ,verbose_name='房屋朝向')
    building_type = models.CharField(max_length=20, blank=True, null=True ,verbose_name='房屋类型')
    house_usage = models.CharField(max_length=20, blank=True, null=True ,verbose_name='房屋用途') 
    double_certificate_situation = models.CharField(max_length=20, blank=True, null=True,verbose_name= '双证情况')
    ...
    building_year = models.CharField(max_length=20, blank=True, null=True,verbose_name='建造年代')
    content_two_five = models.CharField(max_length=20, blank=True, null=True,verbose_name= '满二满五')
    stair_type = models.CharField(max_length=20, blank=True, null=True ,verbose_name='楼梯类型')
    property_year = models.CharField(max_length=120, blank=True, null=True ,verbose_name='产权年限')
    is_unique = models.IntegerField(blank=True, null=True ,verbose_name='是否唯一')
    ladder_household_ratio = models.CharField(max_length=20, blank=True, null=True ,verbose_name='梯户数')
...
class FangxingRelate(models.Model):
    school = models.CharField(max_length=204)
...
class FangxingRent(models.Model):
    '''房星租房'''
    url = models.CharField(max_length=22020, blank=True, null=True)
    uuid = models.CharField(max_length=30, blank=True, null=True ,verbose_name='房源编号')
    rent_price = models.CharField(max_length=20, blank=True, null=True)
    rent_type = models.CharField(max_length=20, blank=True, null=True)
    ...
    house_direction = models.CharField(max_length=20, blank=True, null=True)
    community = models.CharField(max_length=20, blank=True, null=True,verbose_name= '小区名称')
    address = models.CharField(max_length=20, blank=True, null=True ,verbose_name='所在区域')
    ...
    house_usage = models.CharField(max_length=20, blank=True, null=True)
    house_renovation_type = models.CharField(max_length=20, blank=True, null=True)
    stair_type = models.CharField(max_length=20, blank=True, null=True)
    ladder_household_ratio = models.CharField(max_length=20, blank=True, null=True)
    check_in_time = models.CharField(max_length=20, blank=True, null=True)
...
class FangxingXiaoqu(models.Model):
    '''房星小区'''
    url = models.CharField(max_length=22020, blank=True, null=True, verbose_name='数据来源地址')
    ...
    green_rate = models.CharField(max_length=120, blank=True, null=True)
    ...
    park_price = models.CharField(max_length=200, blank=True, null=True)
    building_num = models.IntegerField(blank=True, null=True)
    water_price = models.CharField(max_length=20, blank=True, null=True)
    lift_price = models.CharField(max_length=20, blank=True, null=True)
    decoration_margin = models.CharField(max_length=64, blank=True, null=True)
    maintenance_fund = models.CharField(max_length=20, blank=True, null=True)
    health_price = models.CharField(max_length=20, blank=True, null=True)
    electricity_price = models.CharField(max_length=20, blank=True, null=True)
    gas_price = models.CharField(max_length=20, blank=True, null=True)
    junk_cleaning_price = models.CharField(max_length=20, blank=True, null=True)
    wastewater_price = models.CharField(max_length=20, blank=True, null=True)
    construction_waste_price = models.CharField(max_length=20, blank=True, null=True)
    ...
    property_phone = models.CharField(max_length=20,blank=True, null=True)
    ...
    listing_unit_price = models.CharField(max_length=20, blank=True, null=True)
    listing_unit_mom = models.CharField(max_length=20, blank=True, null=True)
    deal_unit_price = models.CharField(max_length=20, blank=True, null=True)
    deal_unit_mom = models.CharField(max_length=20, blank=True, null=True)
    crawl_time = models.DateTimeField(blank=True, null=True,auto_now=True)
...
class FangxingXuexiao(models.Model):
    '''房星学校'''
    school = models.CharField(max_length=204, blank=True, null=True)
    region = models.CharField(max_length=204, blank=True, null=True)
    school_type = models.CharField(max_length=204, blank=True, null=True)
    school_nature = models.CharField(max_length=204, blank=True, null=True)
    location = models.CharField(max_length=204, blank=True, null=True)
    pair_school = models.CharField(max_length=204, blank=True, null=True)
    uuid = models.CharField(max_length=22020, blank=True, null=True)
    url = models.CharField(max_length=22020, blank=True, null=True)
    crawl_time = models.DateTimeField(blank=True, null=True)
